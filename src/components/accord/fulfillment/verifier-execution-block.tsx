    ...
    <div className="glass-card relative mb-8 overflow-hidden rounded-2xl p-6 md:p-8">
      ...
      {honored && fulfillment ? (
        <div className="space-y-4 text-sm">
          ...
          {fulfillment.proofData && (
            <div className="space-y-2">
              <a
                href={fulfillment.proofData}
                className="inline-flex text-sm font-semibold text-primary-800 underline"
                target="_blank"
              ...
              <img
                src={fulfillment.proofData}
                alt="Justificatif de remboursement"
